...
async def main():
    ...
    "加大高标准农田建设投入，完善建设、验收、管护机制","优化科技创新体系，发展智慧农业","完善粮食生产补贴和保险政策",
    "发展乡村种养业、加工流通业、休闲旅游业等","支持农产品加工产业园和农村电商发展","健全生态保护补偿制度，推进生态综合补偿",
    "提高农村公路、供水、能源等基础设施水平","探索自愿有偿退出办法，保障进城落户农民合法土地权益","推动县域产业协同发展",
    "明确用地类型和供地方式，优化乡村产业发展用地政策","引导县域金融机构支持乡村产业","增加绿色优质农产品供给",
    "保护和开发农业文化遗产、传统建筑等","推动农业与旅游、教育、康养等产业深度融合","发展生态循环农业，健全生态保护补偿机制",
    "巩固农村基本经营制度，健全乡村振兴投入保障机制","优化乡村规划建设"
]
